    ...
    try:
        ...
        while j < total_pages:
            ...
            for i in range(0, len(all2), 5):
                ...
                prop_dict2 = {"Property_image": "https://jeffersonpva.ky.gov" + all2[i].a.img['src'], "property_owner": all2[i+2].text, "property_address": all2[i+1].text, "property_type": all2[i+3].text, "parcel_ID": all2[i+4].text, "Value": all3[2].text, "acres": all3[3].text, "Neighborhood": all3[4].text}
